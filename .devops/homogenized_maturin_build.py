...
if __name__ == "__main__":
    ...
    build_stdout = results.stdout.decode("utf8", errors="ignore").encode("cp1252", errors="ignore").encode("cp1252", errors="ignore")
    build_stderr = results.stderr.decode("utf8", errors="ignore").encode("cp1252", errors="ignore").encode("cp1252", errors="ignore")
    if results.returncode == 0:
