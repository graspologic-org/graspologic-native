...
mod tests {
    ...
    #[test]
    fn test_starting_communities_to_clustering() {
        // test None
        // test empty
        // test gapped
        // test a mapping that includes nodes that aren't in the network
        // test a mapping that doesn't include all the nodes in the network
    }
}
